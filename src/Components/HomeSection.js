...
<div className="mt-3">
    <NavLink style={{borderRadius:"12px"}} className="myButton2" to="/products">Check Products</NavLink>
</div>
</div>
<div className="col-lg-6 order-1 order-lg-2 header_img">
    <img style={{height:"500px"}} src={home} alt="header img" className="img-fluid animated"/>
</div>
</div>
</div>
</div>
