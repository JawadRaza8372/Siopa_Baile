...
function SellerOrderedProductsitems({
  id,
  docid,
  orderdata,
  productsData,
              ...
              <div className="col-md-6 pt-lg-0 order-2 order-lg-2 d-flex justify-content-center align-items-center flex-column">
                ...
                >
                  ...
                  {orderdata && orderdata.orderStatus === "Shipped" ? (
                    ...
                    <p style={{ color: "#dbca00", fontWeight: "bold" }}>
                      Order Status:{orderdata.orderStatus}
                    </p>
                  )}
                  <div
                    style={{ display: "flex", alignItems: "center" }}
                    className="col-xs-10 col-sm-10 col-md-4 col-lg-3 col-xl-3"
                  >
                    <button
